label pucasCh1: 
    ...
    menu: 
        "Stuff the falafel in your mouth.":
            ...
            zach "The can probably smell it all the way in Tristan da Cunha, the world's most remote inhabited island chain."
    ...
    "Frito, Fukklesprout, and Zach strides through the snow to the door of the cabin."
    ...
    menu: 
        "Help him":
            ...
            jacques "Thanks so much, Stell. You're being a huge help! Just grab something and, and I can get the rest."
                menu:
                    "Grab the Drumchata":
