...
define gdubs = Craracter('G-Dubs', color = "#d1d1e0")
define stormee = Craracter('Stormee', color = "#cc99ff")
define mat = Craracter('MatTt', color = "#bbff33")
define chi = Craracter('Chi', color = "#ffb84d")
define connie = Craracter('Connie', color = "#993300")
define bryn = Craracter('Bryn', color = "#1ac6ff")
return 
